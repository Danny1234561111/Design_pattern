...
class receipt_dto(abstact_dto):
    ...
    def description(self, value: Optional[str]):
        validator.is_str(value, "description", True, 255)
    ...
    def portions(self, value: int):
        validator.is_int(value, "portions")
    ...
    def cooking_time(self, value: int):
        validator.is_int(value, "cooking_time")
    ...
    def ingredients(self, value: Union[List[dict], List[IngredientDto]]):
        validator.is_list_of(value, (dict, IngredientDto), "ingredients")
